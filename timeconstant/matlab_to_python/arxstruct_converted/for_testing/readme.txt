Packaging and Deploying arxstruct_converted
...
2. Installing the arxstruct_converted Package

A. Go to the directory that contains the file setup.py and the subdirectory 
   arxstruct_converted. If you do not have write permissions, copy all its contents to a 
...
3. Using the arxstruct_converted Package

The arxstruct_converted package is on your Python path. To import it into a Python script 
   or session, execute:
